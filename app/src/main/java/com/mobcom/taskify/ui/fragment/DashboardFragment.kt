...
import com.mobcom.taskify.R
import com.mobcom.taskify.databinding.FragmentDashboardBinding
import com.mobcom.taskify.databinding.DialogAddTaskBinding
...
class DashboardFragment : Fragment() {
    ...
    private fun showEditTaskDialog(task: com.mobcom.taskify.data.model.Task) {
        val dialogBinding = DialogAddTaskBinding.inflate(layoutInflater)
    ...
    private fun showDeleteConfirmation(task: com.mobcom.taskify.data.model.Task) {
        MaterialAlertDialogBuilder(requireContext())
